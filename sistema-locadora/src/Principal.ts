...
class Principal {
  public static main(): void {
    // Criando filmes
    const filmes: Filme[] = [
      new Filme("O Poderoso Chefão", 1972, "Drama", 5.0),
      new Filme("Matrix", 1999, "Ficção Científica", 4.5),
      new Filme("Interestelar", 2014, "Ficção Científica", 6.0),
      new Filme("Cidade de Deus", 2002, "Drama", 4.0),
      new Filme(
      ...
      new Filme("Pulp Fiction", 1994, "Crime", 4.5),
      new Filme("Van helsing: O caçador de monstros", 2004, "Terror", 7.5),
      new Filme("Clube da Luta", 1999, "Drama", 4.0),
      new Filme("Forrest Gump", 1994, "Drama", 4.5),
      new Filme("Nosferatu", 1922, "Terror", 6.5),
    ];
    ...
    const cliente5 = new Cliente(
      "Abel Silva",
      "555.666.777-88",
      "Rua Emanoel carlos, 202",
      "(11) 9999-5555"
    );

    // Criando contas
    const conta1 = new Conta(cliente1, 1);
    const conta2 = new Conta(cliente2, 2);
    const conta3 = new Conta(cliente3, 3);
    const conta4 = new Conta(cliente4, 4);
    const conta5 = new Conta(cliente5, 5);
